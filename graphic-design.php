        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            <div class="course-detail">
                                ...
                                <div class="topic"><b>2 months 7hours</b></div>
                            </div>
                        </p>
                    </div>
                </div>
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 column2">
                <div class="instructor-course">
                    ...
                    <img src="assets/images/teachermale2.jpg" width="100px" height="100px" alt="">
                    <div class="profile">
                      <div class="">
                         JAMES CATWIN  <i class="fas fa-square    "></i> 7 Curriculum
                      </div>
                ...
                <div class="select mt-3">
                  ...
                  <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade d-flex rate" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                      <img src="assets/images/teachermale2.jpg" alt="">
                      <div class="name">
                        JAMES CATWIN <br>
                        Art Director
                        <div class="icon">
