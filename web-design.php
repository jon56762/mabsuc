        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <div class="course-detail">
                                ...
                                <div class="topic"><b>Frontend</b></div>
                            </div>
                            <div class="course-detail">
                            ...
                            <div class="course-detail">
                                ...
                                <div class="topic"><b>3 months </b></div>
                            </div>
                        </p>
                    </div>
                </div>
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 column2">
                <div class="instructor-course">
                    <h4>Web Design</h4>
                    <img src="assets/images/woman2.jpg" width="100px" height="100px" alt="">
                    <div class="profile">
                      <div class="">
                         JENNY SHEEN  <i class="fas fa-square    "></i> 5 Curriculum
                      </div>
